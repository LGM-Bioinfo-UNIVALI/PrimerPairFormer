...
def split_and_duplicate(row):
    if '@' in row:
        ...
        return pd.Series([valores_divididos[0], valores_divididos[1]])
    else:
...
if __name__ == '__main__':
	...
	create_fasta(seqs, f'get_references2/primers_seqs.fa')

	print('Rodando BLAST NT')
	run_blast(f'./get_references2/primers_seqs.fa', f'./get_references2/primers_seqs_nt.tsv', max_target_seqs='50', num_threads='12')
	print('Rodando BLAST 16S')
	run_blast(f'./get_references2/primers_seqs.fa', f'./get_references2/primers_seqs_16S.tsv', max_target_seqs='50', num_threads='12', database='/media/bioinfo/6tb_hdd/04_Blast_Databases/16sDB/16S_ribosomal_RNA')

	start = time.process_time()

	df_references_nt = pd.read_csv(f'get_references2/primers_seqs_nt.tsv', sep='\t', names=['qseqid', 'pident', 'gaps', 'qcovs', 'mismatch', 'evalue', 'score', 'bitscore', 'sgi', 'sacc', 'slen', 'stitle', 'sscinames'])
	df_references_16S = pd.read_csv(f'get_references2/primers_seqs_16S.tsv', sep='\t', names=['qseqid', 'pident', 'gaps', 'qcovs', 'mismatch', 'evalue', 'score', 'bitscore', 'sgi', 'sacc', 'slen', 'stitle', 'sscinames'])

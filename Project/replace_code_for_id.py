...
# /media/bioinfo/6tb_hdd/03_ELLEN/02_data/primers_references
# DOWNLOADED_FILES
# REPLACED_FILES

# primers_seqs_nt.tsv
# primers_seqs_redo_nt.tsv
# primers_seqs_redo2_nt.tsv

# primers_seqs_16S.tsv
# primers_seqs_redo_16S.tsv
# primers_seqs_redo2_16S.tsv

# primers_seqs.fa
# primers_seqs_redo.fa
# primers_seqs_redo2.fa
...
# fasta_file = SeqIO.to_dict(SeqIO.parse('/media/bioinfo/6tb_hdd/03_ELLEN/02_data/primers_references/primers_seqs_redo.fa', "fasta"))
...
# 		try:
# 			new_primer_code = primer_code.replace(' ', '_')
# 			new_primer_code = new_primer_code.replace('(', '-')
# 			new_primer_code = new_primer_code.replace(')', '-')
...
# REDO2
# primers = pd.read_csv('primers.csv', sep=';')
# fasta_file = SeqIO.to_dict(SeqIO.parse('/media/bioinfo/6tb_hdd/03_ELLEN/02_data/primers_references/primers_seqs_redo2.fa', "fasta"))
...
# 	for primer_id, primer_code in zip(primers['id'], primers['code']):
# 		if primer_id == 3709 or primer_id == 2007:
# 			try:
